# 2026-05-14 Shadow Observation Scorecard
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| low_price_momentum_shadow | shadow_bucket | blocked | 68 | complete | accepted | paper_observation_not_authorized, walk_forward_shadow_monitor_20_trading_days_required, operator_review_required... | 600488.SH 津药药业 |
| breakout_pressure_shadow | shadow_bucket | blocked | 62 | complete | accepted | paper_observation_not_authorized, walk_forward_shadow_monitor_20_trading_days_required, operator_review_required... | 301157.SZ 华塑科技 |
| trend_extension_shadow | shadow_bucket | blocked | 40 | complete | accepted | paper_observation_not_authorized, walk_forward_shadow_monitor_20_trading_days_required, operator_review_required... | 300632.SZ 光莆股份 |
...
- promotion_preflight_json: `reports/strategy_shadow_promotion_preflight_20260514.json`
- promotion_preflight_report: `reports/strategy_shadow_promotion_preflight_20260514.md`
- strategy_shadow_monitor_json: `reports/strategy_shadow_monitor_20260514.json`
- strategy_shadow_monitor_report: `reports/strategy_shadow_monitor_20260514.md`
- walk_forward_csv: `data/strategy_shadow_walk_forward_20260514.csv`
- watchlist_csv: `data/strategy_shadow_watchlist_20260514.csv`
