...
| M100 | Dashboard Chinese IA and detail surfaces | Next | `docs/plans/2026-05-13-m100-m103-cn-ops-quality-plan.md` | Chinese-first Dashboard information architecture and detail drawer/modal cleanup. Primary write scope: `web/dashboard/*`, `tests/test_dashboard_static.py`. Must keep API/internal keys stable and preserve write-safety gates. |
| M101 | Full-market review narrative depth | Next | `docs/plans/2026-05-13-m100-m103-cn-ops-quality-plan.md` | Add Chinese market-regime, sector-continuity, representative-stock, evidence-gap, and next-day-plan narrative. Primary write scope: market-review service/report/tests; no live web fetch or fabricated evidence. |
| M102 | Daily data and stock-pool intake operating loop | Next | `docs/plans/2026-05-13-m100-m103-cn-ops-quality-plan.md` | Make daily review and new-stock intake a repeatable preflight/dry-run/apply/audit path with duplicate-write guards. Primary write scope: daily pipeline script/service/CLI/runbook/tests. |
| M103 | Shadow strategy decision governance | Next | `docs/plans/2026-05-13-m100-m103-cn-ops-quality-plan.md` | Normalize shadow candidate readiness, stop rules, next experiments, manual decisions, and rollback boundaries. Primary write scope: shadow observation/evolution services, shadow scripts/tests/reports; advisory-only. |
...
| --- | --- | --- | --- | --- |
| A | M100 Dashboard Chinese IA and detail surfaces | Next | M99 Chinese-first pass | Fix remaining visible English, reduce flat pages through consistent drawers/modals, and protect Dashboard write gates. Can run in parallel with B/C/D; avoid other Dashboard write sessions. |
| B | M101 Full-market review narrative depth | Next | M48/M76 market hierarchy, M77 evidence ledger | Turn raw full-market data into Chinese regime/sector/stock/evidence/continuity/plan relationship reasoning. No live fetch or fabricated evidence. |
| C | M102 Daily data and stock-pool intake operating loop | Next | M25/M42 daily pipeline, M67 stock-pool intake, M75 ops preflight | Create one repeatable daily path for refresh, pool intake, dry-run, apply, report, audit, and duplicate-write handling. |
| D | M103 Shadow strategy decision governance | Next | M95-M99 shadow evidence and decision memo | Normalize readiness, stop rules, next experiments, human decisions, and rollback boundaries for shadow candidates; advisory-only. |
