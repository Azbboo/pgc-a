...
| M104 | Dashboard production visual QA | Next | `docs/plans/2026-05-14-m104-m107-production-acceptance-plan.md` | Capture desktop/mobile Dashboard QA, fix remaining visible English, overlap, clipped text, dense drawers, and visual polish issues. Primary write scope: `web/dashboard/*`, `tests/test_dashboard_static.py`, optional QA report. |
| M105 | Latest daily data and stock-pool production runbook | Next | `docs/plans/2026-05-14-m104-m107-production-acceptance-plan.md` | Make latest trading-day daily review and new-stock intake executable by child sessions with backup, refresh, pool intake, preflight, dry-run/apply, report, and health evidence. Keep dry-run usable after apply; duplicate apply remains guarded. |
| M106 | Reviewed evidence-pack automation for market/Agent gaps | Next | `docs/plans/2026-05-14-m104-m107-production-acceptance-plan.md` | Improve provider-pack QA/import flow for market and Agent evidence gaps using reviewed files only; no live fetch in trading/report/API/Dashboard paths. |
| M107 | Shadow-to-paper manual promotion preflight | Next | `docs/plans/2026-05-14-m104-m107-production-acceptance-plan.md` | Produce manual-only shadow-to-paper preflight package with readiness, evidence, stop rules, risk/rollback notes, and explicit no strategy/trade/paper-live/timer mutation. |
...
| --- | --- | --- | --- | --- |
| A | M104 Dashboard production visual QA | Next | M100 Chinese IA, deployed Dashboard on port `8020` | Visual QA desktop/mobile for 执行台、每日复盘、全市场复盘、证据/运维、影子策略; fix remaining English, overlap, clipped text, dense drawer polish. |
| B | M105 Latest daily data and stock-pool production runbook | Next | M102 daily operating loop, M67 pool intake | Make latest daily review and stock-pool intake runbook executable with backup, refresh, preflight, dry-run/apply, report, health, and duplicate-write evidence. |
| C | M106 Reviewed evidence-pack automation for market/Agent gaps | Next | M63/M68 evidence packs, M101 narrative gaps | Improve provider-pack QA/import and evidence gap closure using reviewed files only; no live fetch in trading/report/API/Dashboard paths. |
| D | M107 Shadow-to-paper manual promotion preflight | Next | M103 decision queue, M95-M99 shadow evidence | Produce manual-only paper preflight package for shadow candidates; no strategy-version publication, trade plan, paper/live behavior, broker, or timer mutation. |
