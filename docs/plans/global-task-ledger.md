...
| Latest full verification | `463 passed, 3 skipped, 10 subtests passed` locally on 2026-05-13 after M91-M94 Codex review and promotion-review evidence sync fix; focused M91-M94 checks passed (`168 passed, 1 skipped, 1 subtests passed`), post-fix focused API/workbench checks passed (`107 passed, 1 skipped, 1 subtests passed`), direct script smoke passed for `scripts/generate_shadow_replay_backtest_evidence.py` and `scripts/calibrate_shadow_thresholds.py`, `node --check web/dashboard/app.js`, Python compile checks, `git diff --check`, and secret/path scans passed before release. M91 generated 5 replay/backtest evidence artifacts (3 accepted, 2 rejected with explicit stale/metric blockers), M92 workbench now hydrates current evidence even if the review-request artifact was generated before replay evidence, M94 generated artifact-only threshold calibration, and no strategy/trade/paper-live/timer mutation was enabled. |
