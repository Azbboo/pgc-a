...
PYTHONPATH=src python3 -m pgc_trading.cli.main agent review --daily-pick-id 1 --db-path data/pgc_trading.db --account paper-main
PYTHONPATH=src python3 -m pgc_trading.cli.main agent review --daily-pick-id 1 --db-path data/pgc_trading.db --account paper-main --apply --operator azboo
PYTHONPATH=src python3 -m pgc_trading.cli.main plan-cancel --plan-id 1 --reason 高开过大 --db-path data/pgc_trading.db --account paper-main --operator azboo
